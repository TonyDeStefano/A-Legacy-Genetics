...
/** @var \ALegacyGenetics\Controller $this */
...
<?php if ( $page == 'directory' ) { ?>
	...
	$members = \ALegacyGenetics\Member::getActiveMembers();
	$states = array();
	...
	<?php } else { ?>
		...
		<?php foreach ( $states as $state => $members ) { ?>
			...
			<?php /** @var \ALegacyGenetics\Member[] $members */ ?>

			<a name="<?php echo $state; ?>"></a>
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">
						<?php echo \ALegacyGenetics\Controller::get_state_and_abbr( $state ); ?>
					</h3>
				</div>
		...
		<?php if ( $action != 'signedup' ) { ?>
			...
			<div class="col-sm-8">
				...
				<form method="post">
					...
					wp_nonce_field( 'a_legacy_genetics_signup', 'a_legacy_genetics_nonce' );
					...
					<div class="form-group">
						...
						<select class="form-control" id="state" name="state">
							...
							<?php foreach ( \ALegacyGenetics\Controller::get_states() as $abbr => $state ) { ?>
