...
<?php if (have_posts()) : ?>
		<div class="inform">
		    <h1><?php _e( 'Search results for', 'a-legacy-genetics' ); ?> &laquo;<?php the_search_query() ?>&raquo;</h1>
		    <?php get_search_form(); ?>
		</div>
...
<?php else : ?>
	<article class="post">
	    <h1><?php _e( 'No results for ', 'a-legacy-genetics' ); ?> &laquo;<?php the_search_query() ?>&raquo;</h1>
	    <?php get_search_form(); ?>
	 </article>
<?php endif; ?>
